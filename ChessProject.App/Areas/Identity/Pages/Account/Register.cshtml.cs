...
namespace ChessProject.App.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly ChessProjectDbContext _ctx;
        ...
        public async Task<IActionResult> OnPostAsync(CancellationToken token, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userStore.SetUserNameAsync(user, Input.Email, token);
                await _emailStore.SetEmailAsync(user, Input.Email, token);
